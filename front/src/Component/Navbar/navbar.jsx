...
function Navbar() {
  ...
  const handleClick = (tab) => {
    if (tabActive === "chat") {
      setAllNotifsMsg(allNotifsMsg.filter(notifmsg => notifmsg !== witchConvUser));
    }
  ...
  return ( 
    ...
    C202.762,133.194,164.547,165.688,115.762,168.489z"
        ...
        <li className="notifLink" onClick={() => handleClick("notifs")}>
          <div>
            {allNotifsFriendship.length > 0 &&
              <div style={{width: '20px', height: '20px', position: 'absolute', background: 'red', color: 'white', borderRadius: '50px'}}>{allNotifsFriendship.length}</div>
            }
            <svg
              fill="white"
              height="40px"
        ...
        <li className="searchLink" onClick={() => handleClick("search")}>
        ...
        <li className="profileLink" onClick={() => handleClick("profile")}>
          <svg
            fill="white"
            height="40px"
            width="40px"
        ...
        <li className="settingsLink" onClick={() => handleClick("settings")}>
          <svg viewBox="0 0 50 50" width="50px" height="50px" fill="white">
